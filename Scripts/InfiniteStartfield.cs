...
public class InfiniteStartfield : MonoBehaviour {
    ...
    private void CreateStars()
    {
        ...
        {
            points[i].position = UnityEngine.Random.insideUnitSphere * starDistance + tx.position;
    ...
    void Update()
    {
        ...
        for (int i = 0; i < starsMax; i++)
        {
            ...
            {
                points[i].position = UnityEngine.Random.insideUnitSphere.normalized * starDistance + tx.position;
            }
